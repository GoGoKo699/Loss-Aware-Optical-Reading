...
\frac32v\,aa^T-\left(\frac72+\frac32v\right)
...
The [calibration worksheet](CALIBRATION_WORKSHEET.md) supplies separate
...
module or external article code is imported. See [PROOFS.md](PROOFS.md) and
[DEVELOPMENT_NOTES.md](DEVELOPMENT_NOTES.md) for assumptions and failures.
